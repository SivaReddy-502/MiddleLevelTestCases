...
import com.training.pom.MLevelTestcase1POM;
import com.training.utility.DriverFactory;
import com.training.utility.DriverNames;

public class MLevelTestcase1Tests {

	private WebDriver driver;
	private String baseUrl;
	private MLevelTestcase1POM MLevelTestcase1pom;
	...
	public void setUp() throws Exception {
		...
		MLevelTestcase1pom = new MLevelTestcase1POM(driver); 
	...
	public void TestCase3() throws InterruptedException {
		...
		MLevelTestcase1pom.sendUserName("admin");
		//enter valid credentials in Password textbox
		MLevelTestcase1pom.sendPassword("admin@123");
		//click on Login button
		MLevelTestcase1pom.clickLoginBtn(); 
		...
		// click on categories
		MLevelTestcase1pom.clickCategorieslink();
		...
		MLevelTestcase1pom.clickCatogoryCheckbox();
		
		System.out.println("testcase 3: Step 4 : Click on Remove button");
		//Click the Remove button 
		MLevelTestcase1pom.clickRemovebutton();
